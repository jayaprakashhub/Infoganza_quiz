...
//     },
//     {
//       question: 'Which is used to connect your application with a database?',
...
//       if (ans.trim().toUpperCase() === correctAnswers[i].trim().toUpperCase()) score++;
//     });

//     try {
//       const res = await axios.put(`http://localhost:5001/api/submit/${submissionId}`, {
//         answers,
//         score,
//         timeTaken
//       });
...
//       if (res.status === 200) {
//         alert(`Thank you for attending Infoganza_2k25, ${userInfo?.name}!`);
//         setSubmitted(true);
//         Navigate('/')
//       } else {
...
//       <div className="w-full max-w-3xl bg-white shadow-lg p-6 rounded">
//         <h2 className="text-2xl font-bold text-center mb-4">Welcome, {userInfo?.name}</h2>
//         {questions.map((q, i) => (
...
//   //   // 8. Coding Question
//   //   {
//   //     question: 'Write a function to check if a number is prime in JavaScript.',
//   //     answer: 'function isPrime(num) { for(let i = 2; i < num; i++) if(num % i === 0) return false; return num > 1; }'
//   //   },
//   //   // 9. MCQ
//   //   {
...
//   //   // 20. Coding Question
//   //   {
//   //     question: 'Write a function to find the factorial of a number in JavaScript.',
...
//   //   // 24. Coding Question
//   //   {
//   //     question: 'Write a JavaScript function that returns the sum of all even numbers in an array.',
//   //     answer: 'function sumEven(arr) { return arr.filter(num => num % 2 === 0).reduce((acc, num) => acc + num, 0); }'
//   //   },
//   //   // 25. MCQ
//   //   {
...
//   //     answer: 'function sortArray(arr) { return arr.sort((a, b) => a - b); }'
//   //   },
//   //   // 29. MCQ
//   //   {
...
//       if (res.status === 200) {
//         alert(`Thank you for attending the quiz, ${userInfo?.name}!`);
//         setSubmitted(true);
//         navigate("/");
//       } else {
//         alert('Error submitting quiz');
